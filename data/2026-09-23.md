...
### [7] [Adaptive thresholding for scalable measurement-based qubit reset](https://arxiv.org/abs/2609.25208)
...
### [8] [Thermodynamic Proof of Quantumness without Structure](https://arxiv.org/abs/2609.25211)
...
### [9] [Nonlocal advantage of quantum coherence in tau-lepton pairs from electron--positron collisions](https://arxiv.org/abs/2609.25214)
...
### [10] [Localized Decoherence as a Constructive Tool: An Optical Simulation of Matter-Wave Interference](https://arxiv.org/abs/2609.25227)
...
### [11] [Strong coupling of a reconfigurable ${}^{171}$Yb atom array to a tunable telecom-band nanofiber cavity](https://arxiv.org/abs/2609.25232)
...
### [12] [A dual-region ytterbium tweezer apparatus with an in-vacuum nanofiber cavity](https://arxiv.org/abs/2609.25245)
...
### [13] [Operator Score Matching for Learning Quantum Hamiltonians](https://arxiv.org/abs/2609.25246)
...
### [14] [In-orbit operation of a programmable quantum photonic processor](https://arxiv.org/abs/2609.25248)
...
### [15] [Exploring Asymmetric QEC Code Concatenation](https://arxiv.org/abs/2609.25251)
...
### [16] [A Quantum Phase-based Comparator](https://arxiv.org/abs/2609.25262)
...
### [17] [Effective Study of Superconducting Quantum Circuits](https://arxiv.org/abs/2609.25296)
...
### [18] [Thermalization and dephasing in an isolated system of coupled qubits](https://arxiv.org/abs/2609.25336)
...
### [19] [Superradiant Mpemba Relaxation in a Dicke Ladder](https://arxiv.org/abs/2609.25359)
...
### [20] [Low-rank propagation for tridiagonalizable open quantum systems: near-linear scaling with system size](https://arxiv.org/abs/2609.25368)
...
### [21] [Complementarity Test with Unmeasured, Permanently Inaccessible Path Markers](https://arxiv.org/abs/2609.25382)
...
### [22] [Random Gaussian Augmented Matrix Product States](https://arxiv.org/abs/2609.25458)
...
### [23] [A scalable entanglement distribution framework for hybrid quantum networks](https://arxiv.org/abs/2609.25571)
...
### [24] [Efficient Ion-Photon Quantum Interface with Long-Working-Distance Exceeding 26 mm](https://arxiv.org/abs/2609.25598)
...
### [25] [When Quantum Meets AI: Quantum Methods for Machine Learning and Machine Learning Methods for Quantum Systems](https://arxiv.org/abs/2609.25641)
*Tak Hur*
...
### [26] [Schrödingerization for quantum linear systems problems](https://arxiv.org/abs/2609.25660)
...
### [27] [Post-selected enhancement of phase sensitivity in a two-path interferometer](https://arxiv.org/abs/2609.25673)
...
### [28] [$\mathsf{BQP} \subseteq \mathsf{IP}$ Does Not Relativize](https://arxiv.org/abs/2609.25680)
...
### [29] [Post-Selection-Based Stochastic Quantum Battery](https://arxiv.org/abs/2609.25699)
...
### [30] [Enhanced Atomic Magnetometry with a Pinched Spin State](https://arxiv.org/abs/2609.25714)
...
### [31] [The Failure of Simultaneous Quantum Typicality](https://arxiv.org/abs/2609.25726)
*Benoit Collins*
...
### [32] [Photon-Statistics Control of Strong-Field Rydberg-State Excitation](https://arxiv.org/abs/2609.25753)
...
### [33] [An asymmetric atom-photon architecture for device-independent quantum key distribution over 25\,km](https://arxiv.org/abs/2609.25795)
...
### [34] [Exponential Quantum Advantage in Testing Fourier Dimensionality](https://arxiv.org/abs/2609.25816)
*Kenny Chen*
...
### [35] [Quantum survival in hybrid pursuit dynamics - a lion chasing a lamb problem](https://arxiv.org/abs/2609.25844)
...
### [36] [Universal Fidelity Law for Linear-Optical Entangling Gates](https://arxiv.org/abs/2609.25861)
...
### [37] [On the Computational Complexity of Guided Berry Phase Estimation](https://arxiv.org/abs/2609.25929)
*Gabriel Waite*
...
### [38] [Spin-Orbit-Mediated Magnetization Transfer in the Fermi-Hubbard Model](https://arxiv.org/abs/2609.25936)
...
### [39] [Bridge of $Ψ$'s: Quantum Circuit Optimization with Schrödinger Bridges](https://arxiv.org/abs/2609.25947)
...
### [40] [Dynamical, thermal, and ground-state multiparameter quantum metrology: Fundamental limits and their attainability in magnetometry](https://arxiv.org/abs/2609.25977)
...
### [41] [Maximum-Likelihood Amplitude Estimation for Quantum Monte Carlo Integration on Trapped-Ion Hardware: Convergence, Noise-Floor Saturation, Depth-Dependent Bias](https://arxiv.org/abs/2609.25992)
...
### [42] [Hyperbolic Restricted Boltzmann Machine Neural Quantum State](https://arxiv.org/abs/2609.26032)
*H. L. Dao*
...
### [43] [Fisher-Information Geometry Linking Schrodinger Dynamics, Bipartite Correlations, and Decoherence](https://arxiv.org/abs/2609.26159)
...
### [44] [Channel-Constrained Information Scheduling for Quantum Diffusion](https://arxiv.org/abs/2609.26273)
...
### [45] [Effective-Hamiltonian Quantum Solvers for Differential Equations: Alternative Constructions and Function Encodings](https://arxiv.org/abs/2609.26330)
*Annie E. Paine*
...
### [46] [Non-Markovian Charging of a Micromaser Quantum Battery](https://arxiv.org/abs/2609.26341)
...
### [47] [Entanglement Embezzlement from Diffusive Hydrodynamics](https://arxiv.org/abs/2609.26362)
...
### [48] [An Operator-Theoretic Model of Entanglement Percolation in Series-Parallel Quantum Networks](https://arxiv.org/abs/2609.26367)
...
### [49] [Lattice Lindbladian simulation by patching and merging](https://arxiv.org/abs/2609.26372)
*Kaoru Mizuta*
...
### [50] [Photonic CZ gates based on few-photon scattering from emitter-cavity systems](https://arxiv.org/abs/2609.26429)
...
### [51] [I Prove, Therefore I Am: Spatiotemporal Multi-Party Computation](https://arxiv.org/abs/2609.26448)
...
### [52] [Hilbert-space fragmentation selects channels of strong-to-weak spontaneous symmetry breaking](https://arxiv.org/abs/2609.26453)
...
### [53] [Quantum Fisher information of driven-dissipative systems from Keldysh path integrals](https://arxiv.org/abs/2609.26462)
...
### [54] [Tensor Network Simulation of Dynamic Circuits](https://arxiv.org/abs/2609.26516)
...
### [55] [Magnetic tuning of quantum backflow: Schrödinger vs Pauli system](https://arxiv.org/abs/2609.26548)
*Tomasz Radozycki*
...
### [56] [Power-resolved ergotropy and correlation redistribution in a bosonic quantum battery driven by a coherent-state superposition](https://arxiv.org/abs/2609.26573)
...
### [57] [Preselection-Encoded Weak-Value Interferometry for Optical-Rotation Metrology](https://arxiv.org/abs/2609.26583)
...
### [58] [A New Method For Manipulating Circuits, Application To Quantum Adders](https://arxiv.org/abs/2609.26591)
...
### [59] [Hamiltonian Learning and Certification via Eigenphase Engineering](https://arxiv.org/abs/2609.26596)
...
### [60] [Geometric construction of optimal probe states in distributed multiparameter quantum sensing](https://arxiv.org/abs/2609.26608)
...
### [61] [Error Correction Properties of Covariant Bosonic Encodings](https://arxiv.org/abs/2609.26660)
...
### [62] [Fluctuation-Driven Nonlinear Amplification of Quantum Statistics](https://arxiv.org/abs/2609.26674)
