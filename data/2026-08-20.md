...
### [1] [Qkabrine: A Joint Architecture, Encoding, and Hyperparameter Search Framework for Quantum Machine Learning](https://arxiv.org/abs/2608.18152)
*Eric Jagwara*
...
### [2] [Fixed-order postselected CHSH reference acquisition for parity-constrained spatial-mode qubits on a commercial cloud photonic processor](https://arxiv.org/abs/2608.18153)
...
### [3] [How Quantum Is the Advantage? A Fair, Calibration- and Noise-Aware Benchmark and Attribution Audit of Quantum Machine Learning for Network Intrusion Detection](https://arxiv.org/abs/2608.18155)
...
### [4] [Observable Scaling Hierarchies in Multiphoton Dissipative Quantum Sensing](https://arxiv.org/abs/2608.18157)
*Shahram Panahiyan*
...
### [5] [Quantum Processes under Epistemic Constraints](https://arxiv.org/abs/2608.18159)
*Varun Immanuel*
...
### [6] [Symmetric $N \to M$ telecloning and remote quantum state inference](https://arxiv.org/abs/2608.18223)
...
### [7] [Pseudocontexts forced by finite context hypergraphs](https://arxiv.org/abs/2608.18273)
...
### [8] [Generalizing Pauli Checks for Qudit-based Quantum Error Detection and Mitigation](https://arxiv.org/abs/2608.18332)
...
### [9] [Quantum-geometric bounds on Casimir repulsion](https://arxiv.org/abs/2608.18347)
*Adolfo G. Grushin*
...
### [10] [Variational Quantum Algorithms for Hyperelasticity: Incorporating Nonlinear Constitutive Behavior](https://arxiv.org/abs/2608.18363)
...
### [11] [Entropic Rigidity in Quantum Memories: How Geometry and Algebra Control the Onset of Degeneracy Corrections](https://arxiv.org/abs/2608.18420)
*Yixin Zhao,Fei Yan*
...
### [12] [Multiqubit orthogonal product bases](https://arxiv.org/abs/2608.18421)
*Yvkai Zhao,Lin Chen*
...
### [13] [Asymptotic Entanglement Hiding under Stabilizer Restrictions](https://arxiv.org/abs/2608.18440)
...
### [14] [Multicast quantum network coding as optimal symmetric universal cloning over a quantum network](https://arxiv.org/abs/2608.18471)
...
### [15] [Unified Strong-Field Dynamics Simulations from Atoms to Heterostructures](https://arxiv.org/abs/2608.18472)
...
### [16] [Sampling isometric tensor network states with monitored quantum circuits](https://arxiv.org/abs/2608.18511)
...
### [17] [Integer Linear Programming Decoder for Abelian and Non-Abelian Topological Codes](https://arxiv.org/abs/2608.18512)
...
### [18] [Good Stabilizer Codes from Shallow Clifford Circuits with Random Matchings](https://arxiv.org/abs/2608.18536)
...
### [19] [Direct fidelity estimation through joint fiducial grouping](https://arxiv.org/abs/2608.18548)
...
### [20] [Know Your Qubits, Know Your Users: Personas for Quantum Software](https://arxiv.org/abs/2608.18598)
...
### [21] [Inverse Feshbach's problem: Solvability and solutions](https://arxiv.org/abs/2608.18600)
*Miloslav Znojil*
...
### [22] [Exact Matching-Polynomial Solution of the Periodic Baxter-Fendley $Z_N$ Clock Chain](https://arxiv.org/abs/2608.18633)
...
### [23] [Branching (Almost) Everywhere And All at Once](https://arxiv.org/abs/2608.18644)
*Alyssa Ney*
...
### [24] [(Almost) quadruply optimal unitary designs in 1D](https://arxiv.org/abs/2608.18650)
...
### [25] [Quantum-Logic Tsetlin Machines: Interpretable Quantum Machine Learning with Commuting Projector Clauses](https://arxiv.org/abs/2608.18659)
*Krishna Bhatia*
...
### [26] [Experimental zero-added-loss multiplexing Bell-pair source for long-haul quantum networks](https://arxiv.org/abs/2608.18666)
...
### [28] [Robustness of spin state superpositions for noisy quantum metrology](https://arxiv.org/abs/2608.18757)
...
### [29] [Interior skin focusing and directional mirror transfer in a graded non-Hermitian Krawtchouk network](https://arxiv.org/abs/2608.18800)
*Y. S. Liu,X. Z. Zhang*
...
### [30] [Quantum Mixedness Testing with Pauli Measurements](https://arxiv.org/abs/2608.18839)
...
### [31] [Copy-Protection with Correlated Challenges: Point Functions and More via Decisional Coset Monogamy](https://arxiv.org/abs/2608.18841)
...
### [32] [Secure Medical Data Transmission Using Quantum Key Distribution and Post-Quantum Cryptography in Real-World Fiber Networks](https://arxiv.org/abs/2608.18869)
...
### [33] [The exact price of local realism in CHSH experiments: a measurement-dependence-detection trade-off surface, a moiré phase-locking mechanism that saturates it, and an unmeasured fringe in the fourfold coincidence sum](https://arxiv.org/abs/2608.18886)
*Aaron Alai*
...
### [34] [Quantum Tensor Network Learning with DMRG](https://arxiv.org/abs/2608.18901)
...
### [35] [Real Classical Shadows with Noise](https://arxiv.org/abs/2608.18935)
...
### [36] [Quantum-Enhanced Atomic Sensor via Spin Nonequilibrium Criticality](https://arxiv.org/abs/2608.18941)
...
### [37] [AlphaClifford: Efficient Clifford Synthesis and Transpilation with Model-based RL](https://arxiv.org/abs/2608.18946)
...
### [38] [An ultra-bright, highly-scalable, squeezed light source for hybrid quantum photonics](https://arxiv.org/abs/2608.18950)
...
### [39] [Subsystem Symmetries and Fracton Models in Quantum Error Correction](https://arxiv.org/abs/2608.18961)
*Giovanni Canossa*
...
### [40] [Deviation from linear reduced dynamics always occurs for each non-factorisable system-environment unitary evolution](https://arxiv.org/abs/2608.18977)
*Iman Sargolzahi*
...
### [41] [RushHour: A Dynamically Reconfigurable Lattice-Surgery Architecture](https://arxiv.org/abs/2608.18985)
...
### [42] [Interface Capacity and Architectural Replenishment Determine Entanglement-Generation Speed in Quantum Networks](https://arxiv.org/abs/2608.19020)
*Shi-Ju Ran*
...
### [43] [Bernstein-Vazirani Networks: Quantum Machine Learning by Interference](https://arxiv.org/abs/2608.19043)
...
### [44] [Distinct Modes of Quantum Information Transfer in Power-Law Long-Range Spin Networks](https://arxiv.org/abs/2608.19057)
...
### [45] [Non-Local Search-to-Decision Reduction over F2](https://arxiv.org/abs/2608.19091)
*Prabhanjan Ananth*
...
### [46] [Realizing Logical Diagonal Gates via Transversal Physical $Z$-Rotations in CSS Codes](https://arxiv.org/abs/2608.19094)
...
### [47] [Quantum circuit optimization using deep reinforcement learning: Applications across multiple gate sets](https://arxiv.org/abs/2608.19103)
...
### [48] [Connectivity--Interference Competition in Coherent Transport on Percolated Hierarchical Small-World Networks](https://arxiv.org/abs/2608.19130)
...
### [49] [Entanglement battery and entanglement catalyst in local state discrimination problems](https://arxiv.org/abs/2608.19139)
...
### [50] [Quantum Speedups Require Structure or Depth](https://arxiv.org/abs/2608.19158)
...
### [51] [State--Generator Geometry of Open Quantum Systems: Compatibility and Covariant Transport](https://arxiv.org/abs/2608.19175)
