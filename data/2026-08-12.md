...
### [12] [Long-lived memory effects in the defect bath of superconducting qubits](https://arxiv.org/abs/2608.10087)
...
### [13] [Non-equilibrium theory of projected ensembles](https://arxiv.org/abs/2608.10110)
...
### [15] [Williamson majorization theory of fermionic non-Gaussianity](https://arxiv.org/abs/2608.10140)
...
### [16] [Unextendible stabiliser bases](https://arxiv.org/abs/2608.10202)
*Markus Frembs*
...
### [17] [Bayesian approach to simultaneous quantum multiparameter estimation with finite data](https://arxiv.org/abs/2608.10230)
...
### [18] [Programmable Heisenberg-limit sensor from a nonlinear quantum energy pump](https://arxiv.org/abs/2608.10308)
*Yang Peng*
...
### [19] [Wave-particle-mixedness redistribution in Schwarzschild spacetime](https://arxiv.org/abs/2608.10334)
...
### [21] [Private Correlations Certify Sensing Capability](https://arxiv.org/abs/2608.10377)
...
### [22] [A Single Atom in Front of a Mirror is a Universal Reservoir Computer](https://arxiv.org/abs/2608.10382)
...
### [23] [Simultaneous Heisenberg-Limited Multiparameter Metrology via Indefinite Evolution](https://arxiv.org/abs/2608.10490)
...
### [24] [State-Dependent Visibility of Non-Commutative Ordering in Quantum Dynamics](https://arxiv.org/abs/2608.10540)
...
### [25] [Unified Exact Cylindrical Dirac Modes and Symmetry-Resolved Quantum Geometry](https://arxiv.org/abs/2608.10563)
...
### [26] [Stream Decoding with Confidence Scores at Room and Cryogenic Temperatures](https://arxiv.org/abs/2608.10576)
...
### [27] [Generating GKP states using quantum dots inside a strongly coupled cavity](https://arxiv.org/abs/2608.10604)
...
### [28] [Nanoscale graphitization and defect evolution in silicon-vacancy center-containing nanodiamonds under high-pressure high-temperature annealing](https://arxiv.org/abs/2608.10632)
...
### [29] [Zero transfer on mixed graphs](https://arxiv.org/abs/2608.10643)
...
### [30] [Photonic realization of a subgraph extraction in a quantum random network](https://arxiv.org/abs/2608.10663)
...
### [31] [Quantum Computing for Industrial Electromagnetics: Applicability and Case Studies in Solving Maxwell's Equations](https://arxiv.org/abs/2608.10671)
...
### [32] [Optimal fidelity estimation when one state is pure via algorithmic Uhlmann transform](https://arxiv.org/abs/2608.10674)
...
### [33] [Helium-like ions $(Z,e,e)$ in Lagrange Mesh method, interpolating the highly-accurate energy spectra vs. Z](https://arxiv.org/abs/2608.10695)
...
### [34] [Quantum steering is equivalent to state-preserving conditional expectations](https://arxiv.org/abs/2608.10783)
...
### [35] [Resource-bounded controllability benchmarking of open quantum systems](https://arxiv.org/abs/2608.10789)
...
### [36] [A Quantum Algorithm for Solving the Poisson Equation for Free Field Conditions via the Hockney Method](https://arxiv.org/abs/2608.10809)
...
### [37] [Projection measurement of the comb basis through free-electron-photon interactions](https://arxiv.org/abs/2608.10831)
...
### [38] [Theoretical analysis towards accurate optomechanical detection of quantum gravity effects](https://arxiv.org/abs/2608.10890)
...
### [39] [Boosting self hybridized exciton polaritons with metal clad WS2 waveguides](https://arxiv.org/abs/2608.10895)
...
### [40] [A Quantum Dynamics Tutorial: Visualising Dynamical Decoupling Sequences on the Bloch Sphere](https://arxiv.org/abs/2608.10914)
...
### [41] [Quantum Signatures of Two-Electron HBT Interference in Free Space](https://arxiv.org/abs/2608.10917)
...
### [42] [Enhanced two-photon blockade without cascade channel by Stark nonlinear coupling](https://arxiv.org/abs/2608.10942)
...
### [43] [Verifying full quantum network nonlocality in arbitrary configurations by nonlinear Bell-like inequalities](https://arxiv.org/abs/2608.10972)
...
### [44] [The entanglement-assisted transmission capacity is a strong converse bound for identification](https://arxiv.org/abs/2608.11000)
*Satvik Singh*
...
### [45] [Entanglement depth and ancilla efficiency in quantum channel estimation](https://arxiv.org/abs/2608.11042)
*Javid Naikoo*
...
### [46] [Quantum Coordination Advantages in AI State-Tracking Tasks: Semantic Compilation and Latent Memory](https://arxiv.org/abs/2608.11066)
*Ming Yang*
...
### [47] [Physics-Constrained Compressed Sensing for Quantum Sensing in the Data-Starved Regime](https://arxiv.org/abs/2608.11092)
*Amir Kalev*
...
### [48] [Robust CHSH Self-Testing with Finite-Energy GKP States](https://arxiv.org/abs/2608.11122)
...
### [49] [A Sharp Local-Question Threshold for GHZ-Equatorial Completeness in Four-Player XOR Games](https://arxiv.org/abs/2608.11139)
...
### [50] [Breaking the Quadratic Barrier for von Neumann Entropy Estimation](https://arxiv.org/abs/2608.11151)
...
### [51] [Quantum Codes with Arbitrary Z-Rotation logical Gates and Applications to Fault-Tolerant Code Switching](https://arxiv.org/abs/2608.11160)
...
### [52] [Impact of strain and dark states on spectroscopic measurements of silicon-vacancy centers in diamond](https://arxiv.org/abs/2608.11168)
...
### [53] [A Quantum Roadmap for Softmax Attention: Exact Born-Rule Analogs for Softmax Attention on the Probability Simplex](https://arxiv.org/abs/2608.11173)
...
### [54] [Statistically-Secure Bit Commitment and Coin Flipping Protocols Based on Quantum Hardware Assumptions](https://arxiv.org/abs/2608.11187)
...
### [55] [Work distribution for strongly coupled many-body open quantum systems](https://arxiv.org/abs/2608.11196)
